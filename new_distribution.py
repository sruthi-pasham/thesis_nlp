...
with open('/content/drive/MyDrive/testing/excel/prospects(cs,sd).csv', 'r') as f:
...
pattern = '/content/drive/MyDrive/testing/job_posts/*.json'
...
df_prospects = df_prospects[df_prospects['Job Prospect'] != 'software engineer']
df_prospects = df_prospects[df_prospects['Job Prospect'] != 'developer']
...
cartesian_title_x_prospect['RESULT'] = cartesian_title_x_prospect.apply(lambda x: x['Job Prospect'] if x['Job Prospect'] in x['title'] else     
                                                                              ...
                                                                              ('developer' if 'coding' in x['title'] or 'programmer' in x['title'] else 
                                                                               #('it Business Analyst' if 'business' in x['title'] else
                                                                               ('software engineer' if 'software engineer' in x['title'] else (0) 
...
print(top_15_counts)
top_15_jobs = ['software engineer', 'developer',  'full stack developer', 'front-end developer', 'backend developer', 'python developer', 'ui/ux designer', 'devops engineer', 'java developer', 'data engineer', 
 'site reliability engineer', 'infrastructure consultant', 'security engineer', 'software architect', 'data scientist']
